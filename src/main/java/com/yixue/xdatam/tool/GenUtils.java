...
import com.yixue.xdatam.entity.sys.ColumnEntity;
import com.yixue.xdatam.entity.sys.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", Constant.DateUtils.format(new Date(), Constant.DateUtils.DATE_TIME_PATTERN));
